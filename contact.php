...
$address = 'info@trustfutureministries.org';
...
$e_body = "New message from $first_name $last_name" . PHP_EOL . PHP_EOL;
$e_content = $comments . PHP_EOL . PHP_EOL;
$e_reply = "You can contact $first_name via email at $email or by phone on $phone";
...
if (mail($address, $e_subject, $msg, $headers)) {
    ...
    echo "<p>Thank you <strong>$first_name</strong> for contacting us, we will get back to you the soonest.</p>";
    echo '</div>';
    echo '</fieldset>';
} else {
    echo 'ERROR!';
